...
//---------------------------------------------------------------------------------------------------------------------------
void genOneBoardCard(unique_ptr< QVector<Card> > & board_ptr, unique_ptr<Deck> & deck_ptr, const Hand & hero_h, const Hand & opp_h,
                              ...
                              unique_ptr<HandStrengthList> & hsl, const int & count_cycles)
{
    ...
    unique_ptr< QVector<Card> > board_ptr(new QVector<Card>);
...
//---------------------------------------------------------------------------------------------------------------------------
void sumHandStrength(const Hand & hand, const unique_ptr< QVector<Card> > & board_ptr, unique_ptr<HandStrengthList> & hsl)
{
