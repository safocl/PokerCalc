...
Hand::Hand( const std::string str1, const std::string str2 )
    : card1( std::make_unique< Card >( str1 ) ), card2( std::make_unique< Card >( str2 ) ) {
...
//---------------------------------------------------------------------------------------------------------------------------
void Hand::setHand( Card::valCard numValueCard1, Card::suitCard numSuitCard1, Card::valCard numValueCard2,
...
bool Hand::operator==( const Hand & other ) const {
    return ( ( ( this->card1.operator*() == other.card1.operator*() ) &&
               ( this->card2.operator*() == other.card2.operator*() ) ) ||
             ( ( this->card1.operator*() == other.card2.operator*() ) &&
               ( this->card2.operator*() == other.card1.operator*() ) ) );
}
//---------------------------------------------------------------------------------------------------------------------------
bool Hand::operator!=( const Hand & other ) const {
    return !( ( ( this->card1.operator*() == other.card1.operator*() ) &&
